...
Feature: Validating calculate and order creation functionalities
  ...
  Scenario Outline: Validating create order functionality
    ...
    Examples:
      | product     | quantity | name        | street      | city    | state | zip   | cc               | expire date |
      | MyMoney     | 10       | John Doe    | 123 My Road | Chicago | IL    | 12345 | 1234123412341234 | 12/21       |
      | FamilyAlbum | 5        | Patel Harsh | 124 My Road | Chicago | IL    | 12345 | 1234723412341234 | 07/21       |
      | ScreenSaver | 1        | Kim Yan     | 125 My Road | Chicago | IL    | 12345 | 1234121912341234 | 03/21       |